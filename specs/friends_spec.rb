...
class TestFriends < MiniTest::Test
  ...
  # 3. For a given person, check if they like a particular snacks
  # (e.g. the function likes_to_eat(@person2, "bread") should return true, likes_to_eat(@person3, "spinach") should return false)
  def test_favourite_snacks_check_true
    result = favourite_snacks_check(@person2, "bread")
    assert_equal(true, result)
  end

  def test_favourite_snacks_check_false
    result = favourite_snacks_check(@person3, "spinach")
  ...
  def test_lend_money_lendee_increase
    result = lend_money(@person4, @person5, 5)
    assert_equal(25, result)
  end

  def test_lend_money_lender_decrease
    result = lend_money(@person4, @person5, 5)
  ...
  # 8. Find the set of everyone's favourite snacks joined together
...
#   assert_equal(1, find_no_friends)
#
#
# end
